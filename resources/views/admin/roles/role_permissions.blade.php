                   ...
                   <div class="row">
                    <div class="col-6 offset-3">
                        <div class="list-group">
                            <h1 class="list-group-item list-group-item-action mt-2">مجوز های نقش {{ $role->name }}</h1>
                            @foreach ($permissions as $permission )
                                <div class="form-check d-flex align-items-center">
                                    ...
                                    <label for="" class="list-group-item list-group-item-action mt-2">{{ $permission->name }}</label>
                                </div>
                            @endforeach
                        </div>
                    </div>
