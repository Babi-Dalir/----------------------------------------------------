            ...
            <div class="col-xl-10 col-lg-9 col-12 order-1 order-lg-2">
                ...
                <section id="main-slider-res"
                    ...
                    <ol class="carousel-indicators">
                        ...
                        <li data-target="#main-slider" data-slide-to="0"  @if($loop->first) class="active" @endif></li>
                        @endforeach
                    </ol>
                    <div class="carousel-inner">
                        @foreach ($sliders as $slider )
                        ...
                        @foreach ($spacial_products as $spacial_product )
                            ...
                            <div class="product-card">
                                ...
                                <a class="product-thumb" href="{{ route('single.product',$spacial_product->product->slug) }}">
                                    <img src="{{ url('images/products/big/'.$spacial_product->product->image) }}" alt="Product Thumbnail">
                                </a>
                                <div class="product-card-body">
                                    <h5 class="#">
                                        <a href="{{ route('single.product',$spacial_product->product->slug) }}">{{ $spacial_product->product->title }}</a>
                                    </h5>
                                    <a class="product-meta" href="#">{{ $spacial_product->product->category->title }}</a>
                                    <span class="product-price">{{ $spacial_product->price }} تومان</span>
                                </div>
                            </div>
                            </div>
                        @endforeach
                    ...
                    <div class="product-carousel carousel-lg owl-carousel owl-theme">
                        @foreach ($newest_products as $newest_product )
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-card-body">
                                    <h5 class="#">
                                        <a href="shop-single.html">{{ $newest_product->title }}</a>
                                    </h5>
