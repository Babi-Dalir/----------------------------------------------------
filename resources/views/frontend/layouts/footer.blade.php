        ...
        <div class="footer-widgets">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="widget-menu widget card">
                        <header class="card-header">
                            <h3 class="card-title">راهنمای خرید از کدیاد کالا</h3>
                        </header>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="widget-menu widget card">
                        <header class="card-header">
                            <h3 class="card-title">با کدیاد کالا</h3>
                        </header>
                        <ul class="footer-menu">
                            <li>
                                <a href="#">فروش در کدیاد کالا</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#">تماس با کدیاد کالا</a>
                            </li>
                            <li>
                                <a href="#">درباره کدیاد کالا</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container main-container">
            <div class="row">
                <div class="site-description col-12 col-lg-7">
                    <h1 class="site-title">فروشگاه اینترنتی کدیاد کالا، بررسی، انتخاب و خرید آنلاین</h1>
                    <p>
                        کدیاد کالا به عنوان یکی از قدیمی‌ترین فروشگاه های اینترنتی با بیش از یک دهه تجربه، با
                        ...
                        اینترنتی ایران تبدیل شود. به محض ورود به کدیاد کالا با یک سایت پر از کالا رو به رو
