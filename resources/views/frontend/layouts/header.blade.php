        ...
        <div class="container main-container">
            ...
            <nav class="main-menu d-flex justify-content-md-between justify-content-end dt-sl">
                <ul class="list hidden-sm">
                                    ...
                                    <ul class="row">
                                        @foreach($cat1->childCategory as $cat2)
                                            <li class="sublist--title"><a
                                                    href="{{route('search.category.product.list',$cat2->slug)}}">{{$cat2->title}}</a>
                                            </li>
                                            @foreach($cat2->childCategory as $cat3)
                                                <li class="sublist--item"><a
                                                        href="{{route('search.category.product.list',[$cat2->slug,$cat3->slug])}}">{{$cat3->title}}</a>
                                                </li>
                                            @endforeach
                                        @endforeach
                                    </ul>
                    ...
                    <li class="list-item">
                        <a class="nav-link" href="#">تخفیف ها وپیشنهادات</a>
                    </li>
                    <li class="list-item">
