                        ...
                        @if ($product->spacial_expiration != null && $product->spacial_expiration > now())
                         ...
                         @endif
                            ...
                            <div class="product-card-body">
                                ...
                                <a class="product-meta" href="{{ route('single.product',$product->slug) }}">{{ $product->category->title }}</a>
            ...
            <div class="ah-tab-content dt-sl" @if(count($moreViewedProducts)>0) data-ah-tab-active="true" @endif>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        {{ $moreViewedProducts->links('vendor.pagination.products-pagination.more-viewed-products') }}
                        @endif
                    </div>
                </div>
            </div>
