                                            ...
                                            <div class="checkout-address-box @if ($address->is_default) is-selected @endif">
                                                ...
                                                <ul class="checkout-address-list">
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <button class="checkout-address-btn-edit" wire:click="$emit('editAddress',{{ $address->id }})"
                                                                        data-toggle="modal"
                                                                        data-target="#modal-location-edit">ویرایش</button>
                                                            </li>
                                                            <li>
                                                                <button class="checkout-address-btn-remove" wire:click="$emit('showDeletetAddress',{{ $address->id }})"
                                                                        data-toggle="modal"
            ...
            <ul class="checkout-summary-summary">
                ...
                <li>
                    <span>هزینه ارسال<span class="help-sn" data-toggle="tooltip" data-html="true"
                        ...
                        </span></span><span>@if($total_price > 150000) رایگان @else {{ number_format($send_price) }} @endif </span>
                </li>
