            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <figure class="avatar avatar">
                        <img src="{{ url('images/products/small/'.$product_guaranty->product->image) }}" class="rounded-circle" alt="image">
                    </figure>
                </td>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-info" href="{{ route('edit.product.guaranties',[$product_guaranty->id,$product_guaranty->product->id]) }}">
                        ویرایش
                    </a>
                </td>
                <td class="text-center align-middle">
