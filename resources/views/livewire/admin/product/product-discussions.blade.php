<div class="table overflow-auto" tabindex="8">
    ...
    <div class="row m-1">
        <a href="{{ route('create.product.discussions',$product_id) }}" class="btn btn-outline-skype">ایجاد نقد وبرسی</a>
    </div>
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th class="text-center align-middle text-primary">عنوان نقد وبرسی</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance($discussion->created_at)->format(' %d,%B %Y')}}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
