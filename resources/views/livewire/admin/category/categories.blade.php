    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <a href="{{ route('categories.trashed') }}" class="btn btn-outline-warning">
                <i class="ti-trash">دسته بندی های حذف شده</i>
            </a>
        </div>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tr>
                                                        <td class="text-center align-middle">
                                                            <figure class="avatar avatar">
                                                                <img src="{{ url('images/categories/small/'.$cat1->image) }}" class="rounded-circle" alt="image">
                                                            </figure>
                                                        </td>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <table class="table table-striped table-hover">
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-center align-middle">
                                                                                    <figure class="avatar avatar">
                                                                                        <img src="{{ url('images/categories/small/'.$cat2->image) }}" class="rounded-circle" alt="image">
                                                                                    </figure>
                                                                                </td>
