<div class="table overflow-auto" tabindex="8">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th class="text-center align-middle text-primary">شماره ی اقتصادی</th>
        ...
        @foreach ($sellers as $index=>$seller )
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{$seller->company_economy_name}}</td>
                ...
                <td class="text-center align-middle" wire:click='chaneSellerStatus({{ $seller->id }})'>
                    ...
                    @elseif ($seller->status==\App\Enums\CompanyStatus::Request->value)
                        <span class="cursor-pointer badge badge-warning">درخواست اولیه</span>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-info" href="{{url('files/contracts/'.$seller->company_name.'/'.$seller->file)}}">
                        دانلود قرارداد
                    </a>
                </td>
