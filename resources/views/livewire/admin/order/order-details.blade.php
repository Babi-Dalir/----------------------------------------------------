        ...
        @foreach ($orders as $index=>$order )
            ...
            <tr>
                ...
                <td class="text-center align-middle" wire:click='chaneOrderDetailsStatus({{ $order->id }})'>
                    @if ($order->status==\App\Enums\OrderDetailStatus::Processing->value)
                        <span class="cursor-pointer badge badge-info">درحال پردازش</span>
                    ...
                    @elseif ($order->status==\App\Enums\OrderDetailStatus::Waiting->value)
