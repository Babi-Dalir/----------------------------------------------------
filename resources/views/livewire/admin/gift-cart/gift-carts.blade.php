<div class="table overflow-auto" tabindex="8">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th class="text-center align-middle text-primary">میزان قیمت کارت هدیه</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{\Hekmatinasser\Verta\Verta::instance($gift->expiration_date)->format(' %d,%B %Y')}}</td>
                ...
                <td class="text-center align-middle">{{\Hekmatinasser\Verta\Verta::instance($gift->created_at)->format(' %d,%B %Y')}}</td>
            </tr>
            @endforeach
