...
class Category extends Model
{
    ...
    public static function createCategory($request)
    {
        Category::query()->create([
            ...
            'image' => ImageManager1::saveImage('categories', $request->image),
        ]);
    }
    public static function updateCategory($request, $category)
    {
        $category->update([
            ...
            'slug' => str()->slug($request->etitle),
            'parent_id' => $request->input('parent_id'),
            'image' => $request->image ? ImageManager1::saveImage('categories', $request->image) : $category->image,
        ]);
    }
