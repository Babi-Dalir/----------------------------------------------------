...
class ProductFilters extends Component
{
    ...
    public function addBrands($brand_id){
        ...
        $this->emit('filteredProducts',$this->filtered_brands,$this->filtered_guaranties,$this->filtered_colors);

    }
    public function addGuaranties($guaranty_id){
        if(!in_array($guaranty_id,$this->filtered_guaranties)){
            array_push($this->filtered_guaranties,$guaranty_id);
        }else{
            if(($key=array_search($guaranty_id,$this->filtered_guaranties)) !== false){
                unset($this->filtered_guaranties[$key]);
            }
        }
        $this->emit('filteredProducts',$this->filtered_brands,$this->filtered_guaranties,$this->filtered_colors);
    }
