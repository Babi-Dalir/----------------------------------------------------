...
class ProductProperties extends Component
{
    ...
    public function deleteProductPropertyGroup($property_group_id) //برای دکمه ی حذف ویژگی ها
    {
    ...
    public function deleteProductProperty($property_id,$property_group_id) //برای دکمه ی سطل زباله جلوی ویزگی
    {
