...
class Products extends Component
{
    ...
    public function render()
    {
        ...
        $product_guaranties=ProductGuaranty::query()->whereNotIn('id',$existProductsInVendor)
            ->whereHas('product', function ($q){
                $q->where('title','like','%'.$this->search.'%');
            })
            ->paginate(5);
        return view('livewire.admin.vendor.products',compact('product_guaranties','vendor_products'));
    }
}
