...
class ProvinceController extends Controller
{
    ...
    {
        Province::createProvice($request);
        return redirect()->route('provinces.index')->with('message','استان با موفقیت ایجاد شد');
    }
    ...
    {
        Province::updateProvice($request,$id);
