...
class DiscussionController extends Controller
{
    ...
    public function store(Request $request,$product_id)
    {
        ...
        return redirect()->route('product.discussions',$product_id)->with('message',' نقد وبرسی  با موفقیت ایجاد شد');
    }
    ...
    public function update(Request $request, string $id,$product_id)
    {
        ...
        return redirect()->route('product.discussions',$product_id)->with('message','نقد وبرسی با موفقیت ویرایش شد');
