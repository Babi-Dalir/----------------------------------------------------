...
class PermissionController extends Controller
{
    ...
    public function store(PermissionRequest $request)
    {
        ...
        return redirect()->route('permission.index')->with('message','مجوز با موفقیت ایجاد شد');
    }
    ...
    public function update(PermissionRequest $request, string $id)
    {
        ...
        return redirect()->route('permission.index')->with('message','مجوز با موفقیت ویرایش شد');
    }
    /**
